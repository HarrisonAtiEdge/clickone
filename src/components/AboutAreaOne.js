          ...
          <div className='row'>
            ...
            >
              <div className='section-title mt-5 mt-lg-0'>
                ...
                <h2 className='title'>
                Why Choose <span>ClickOnes?</span> 
                </h2>
                <p className='content mb-4 mb-xl-5'>
                ClickOnes simplifies business operations as Pakistan embraces digital transformation. We're dedicated to helping you grow by taking your business online and accessing new markets.
                </p>
                <div className='row'>
